    ...
    const testimonials = [
      {
        name: 'Sara Abebe',
        rating: 5,
        comment: 'Very fast and reliable service. Got my TikTok followers in just 2 hours!',
        image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80'
      },
      {
        name: 'Kaleb Tadesse',
        rating: 4.5,
        comment: 'Great service for Instagram followers. Will use again.',
        image: 'https://images.unsplash.com/photo-1531891437562-4301cf35b7e4?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80'
      }
    ];
